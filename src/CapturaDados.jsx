        ...
        <div className="container d-flex flex-column gap-4 text-start justify-content-start">
            ...
            <div className="row">
                <div className="col-6">
                    ...
                    <input name="valor-inicial" className="form-control" type="text" value={valorInicial} onChange={(e) =>
                        setValorInicial(e.target.value)
                    }></input>

                    <label className="form-label mt-2 small">Taxa de Juros (% ao mês)</label>
                    <input name="taxa-de-juros" className="form-control" type="text" value={taxaJuros} onChange={(e) =>
                ...
                <div className="col-6">
                    ...
                    <input name="aporte-mensal" className="form-control" type="text" value={aporteMensal} onChange={(e) =>
                        setAporteMensal(e.target.value)
                    }></input>

                    <label className="form-label mt-2 small">Período (meses)</label>
                    <input name="periodo" className="form-control" type="text" value={periodoMeses} onChange={(e) =>
